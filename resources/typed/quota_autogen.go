...
type QuotaRequestBody struct {
	...
	IsPhysicalQuota      bool                               `json:"is_physical_quota,omitempty" yaml:"is_physical_quota,omitempty" required:"false" doc:"Whether to limit by Physical Capacity. Default is Logical. Cannot be updated."`
	...
	QuotaGroupsIds       *[]int64                           `json:"quota_groups_ids,omitempty" yaml:"quota_groups_ids,omitempty" required:"false" doc:""`
