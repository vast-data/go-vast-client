...
type QuotaRequestBody struct {
	...
	DefaultEmail         string `json:"default_email,omitempty" yaml:"default_email,omitempty" required:"false" doc:""`
	EnableAlarms         bool   `json:"enable_alarms,omitempty" yaml:"enable_alarms,omitempty" required:"false" doc:""`
