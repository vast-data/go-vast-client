...
type EncryptionGroupSearchParams struct {
	Guid expr.StrField `json:"guid,omitempty" yaml:"guid,omitempty" required:"true" doc:""`
...
// GetById retrieves a single encryptiongroup by ID
func (r *EncryptionGroup) GetById(id any) (*EncryptionGroupDetailsModel, error) {
	return r.GetByIdWithContext(r.Untyped.GetCtx(), id)
}

// GetByIdWithContext retrieves a single encryptiongroup by ID using provided context
func (r *EncryptionGroup) GetByIdWithContext(ctx context.Context, id any) (*EncryptionGroupDetailsModel, error) {
