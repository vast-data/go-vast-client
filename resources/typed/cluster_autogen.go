...
type ClusterRequestBody struct {
	...
	DeleteSnapBlocksThreshold                      int64                                        `json:"delete_snap_blocks_threshold,omitempty" yaml:"delete_snap_blocks_threshold,omitempty" required:"false" doc:"Delete snap blocks threshold"`
	...
	DisableMetrics                                 bool                                         `json:"disable_metrics,omitempty" yaml:"disable_metrics,omitempty" required:"false" doc:"Disable dev metrics collection"`
	...
	EkmBypassValidation                            bool                                         `json:"ekm_bypass_validation,omitempty" yaml:"ekm_bypass_validation,omitempty" required:"false" doc:"Bypass key and cert validation"`
	...
	SecondaryEkmPort                               int64                                        `json:"secondary_ekm_port,omitempty" yaml:"secondary_ekm_port,omitempty" required:"false" doc:"EKM port"`
...
//   - Extra method PATCH /clusters/block_providers/ skipped: PATCH /clusters/block_providers/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /clusters/block_providers/
...
//   - Extra method POST /clusters/{id}/notify_new_version/ skipped: POST /clusters/{id}/notify_new_version/ - No response schema defined in OpenAPI spec. Error: no valid schema found in POST response (200/201/202) for resource /clusters/{id}/notify_new_version/
//   - Extra method POST /clusters/{id}/set_drive_fw_upgrade/ skipped: POST /clusters/{id}/set_drive_fw_upgrade/ - No response schema defined in OpenAPI spec. Error: no valid schema found in POST response (200/201/202) for resource /clusters/{id}/set_drive_fw_upgrade/
