...
type GlobalSnapshotStreamRequestBody struct {
	...
	ViewReplicationEnabled bool                                          `json:"view_replication_enabled,omitempty" yaml:"view_replication_enabled,omitempty" required:"false" doc:"Enables view replication"`
}
