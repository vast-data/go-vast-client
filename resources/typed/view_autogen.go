...
// Generated from GET response for resource: views
type ViewDetailsModel struct {
...
// PrettyTable returns a formatted table representation of the ViewDetailsModel
func (m *ViewDetailsModel) PrettyTable() string {
	return core.ModelToRecord(m).PrettyTable()
}

// PrettyJson returns a JSON representation of the ViewDetailsModel
func (m *ViewDetailsModel) PrettyJson(indent ...string) string {
	return core.ModelToRecord(m).PrettyJson(indent...)
}

// ViewUpsertModel represents the model returned by Create/Update operations
// Generated from POST response for resource: views
type ViewUpsertModel struct {
	Path                          string                              `json:"path,omitempty" yaml:"path,omitempty" required:"true" doc:"The Element Store path exposed by the view. Begin with a forward slash. Do not include a trailing slash"`
	AbacTags                      *[]string                           `json:"abac_tags,omitempty" yaml:"abac_tags,omitempty" required:"false" doc:"Comma separated tags."`
	AbeMaxDepth                   int64                               `json:"abe_max_depth,omitempty" yaml:"abe_max_depth,omitempty" required:"false" doc:"Restricts ABE to a specified path depth. For example, if max depth is 3, ABE does not affect paths deeper than three levels. If not specified, ABE affects all path depths."`
	AbeProtocols                  *[]string                           `json:"abe_protocols,omitempty" yaml:"abe_protocols,omitempty" required:"false" doc:"The protocols for which Access-Based Enumeration (ABE) is enabled"`
...
// PrettyTable returns a formatted table representation of the ViewUpsertModel
func (m *ViewUpsertModel) PrettyTable() string {
	return core.ModelToRecord(m).PrettyTable()
}

// PrettyJson returns a JSON representation of the ViewUpsertModel
func (m *ViewUpsertModel) PrettyJson(indent ...string) string {
	return core.ModelToRecord(m).PrettyJson(indent...)
}
...
func (r *View) Update(id any, req *ViewRequestBody) (*ViewUpsertModel, error) {
...
func (r *View) UpdateWithContext(ctx context.Context, id any, req *ViewRequestBody) (*ViewUpsertModel, error) {
	params, err := core.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) EnsureByName(name string, body *ViewRequestBody) (*ViewUpsertModel, error) {
...
func (r *View) EnsureByNameWithContext(ctx context.Context, name string, body *ViewRequestBody) (*ViewUpsertModel, error) {
	bodyConverted, err := core.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
