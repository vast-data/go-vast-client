...
//   - Extra method PATCH /vms/{id}/remove_client_certificate/ skipped: PATCH /vms/{id}/remove_client_certificate/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/remove_client_certificate/
//   - Extra method PATCH /vms/{id}/reset_certificate/ skipped: PATCH /vms/{id}/reset_certificate/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/reset_certificate/
//   - Extra method PATCH /vms/{id}/reset_ssl_ciphers/ skipped: PATCH /vms/{id}/reset_ssl_ciphers/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/reset_ssl_ciphers/
//   - Extra method PATCH /vms/{id}/set_certificate/ skipped: PATCH /vms/{id}/set_certificate/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/set_certificate/
//   - Extra method PATCH /vms/{id}/set_client_certificate/ skipped: PATCH /vms/{id}/set_client_certificate/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/set_client_certificate/
//   - Extra method PATCH /vms/{id}/set_max_api_tokens_per_user/ skipped: PATCH /vms/{id}/set_max_api_tokens_per_user/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/set_max_api_tokens_per_user/
//   - Extra method PATCH /vms/{id}/set_ssl_ciphers/ skipped: PATCH /vms/{id}/set_ssl_ciphers/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/set_ssl_ciphers/
//   - Extra method PATCH /vms/{id}/set_ssl_port/ skipped: PATCH /vms/{id}/set_ssl_port/ - No response schema defined in OpenAPI spec. Error: no valid schema found in PATCH response (200/201/202) for resource /vms/{id}/set_ssl_port/
