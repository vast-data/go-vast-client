...
// Generated from GET response for resource: vippools
type VipPoolDetailsModel struct {
...
// PrettyTable returns a formatted table representation of the VipPoolDetailsModel
func (m *VipPoolDetailsModel) PrettyTable() string {
	return core.ModelToRecord(m).PrettyTable()
}

// PrettyJson returns a JSON representation of the VipPoolDetailsModel
func (m *VipPoolDetailsModel) PrettyJson(indent ...string) string {
...
// Generated from POST response for resource: vippools
type VipPoolUpsertModel struct {
	ActiveCnodeIds          *[]int64     `json:"active_cnode_ids,omitempty" yaml:"active_cnode_ids,omitempty" required:"false" doc:"IDs of active CNodes"`
	ActiveInterfaces        int64        `json:"active_interfaces,omitempty" yaml:"active_interfaces,omitempty" required:"false" doc:"Number of active interfaces"`
	BgpConfigId             int64        `json:"bgp_config_id,omitempty" yaml:"bgp_config_id,omitempty" required:"false" doc:"The ID of the BGP configuration applied for L3 connectivity"`
	Cluster                 string       `json:"cluster,omitempty" yaml:"cluster,omitempty" required:"false" doc:"Parent cluster"`
...
// PrettyTable returns a formatted table representation of the VipPoolUpsertModel
func (m *VipPoolUpsertModel) PrettyTable() string {
	return core.ModelToRecord(m).PrettyTable()
}

// PrettyJson returns a JSON representation of the VipPoolUpsertModel
func (m *VipPoolUpsertModel) PrettyJson(indent ...string) string {
	return core.ModelToRecord(m).PrettyJson(indent...)
}
...
func (r *VipPool) EnsureByName(name string, body *VipPoolRequestBody) (*VipPoolUpsertModel, error) {
...
func (r *VipPool) EnsureByNameWithContext(ctx context.Context, name string, body *VipPoolRequestBody) (*VipPoolUpsertModel, error) {
	bodyConverted, err := core.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
