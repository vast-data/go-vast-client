...
// SupporteddriveModel_DrivesItem represents a nested type for model
type SupporteddriveModel_DrivesItem struct {
	CapacityTb int64                                    `json:"capacity_tb,omitempty" yaml:"capacity_tb,omitempty" required:"false" doc:""`
	Fw         *[]SupporteddriveModel_DrivesItem_FwItem `json:"fw,omitempty" yaml:"fw,omitempty" required:"false" doc:""`
	HwPlatform *[]string                                `json:"hw_platform,omitempty" yaml:"hw_platform,omitempty" required:"false" doc:""`
	Model      string                                   `json:"model,omitempty" yaml:"model,omitempty" required:"false" doc:""`
	Name       string                                   `json:"name,omitempty" yaml:"name,omitempty" required:"false" doc:""`
	Type       string                                   `json:"type,omitempty" yaml:"type,omitempty" required:"false" doc:""`
...
// SupporteddriveModel_DrivesItem_FwItem represents a nested type for model
type SupporteddriveModel_DrivesItem_FwItem struct {
	Latest bool   `json:"latest,omitempty" yaml:"latest,omitempty" required:"false" doc:""`
	Name   string `json:"name,omitempty" yaml:"name,omitempty" required:"false" doc:""`
}

// SupporteddriveModel_PlatformsItem represents a nested type for model
type SupporteddriveModel_PlatformsItem struct {
	DefaultSectionLayout string `json:"default_section_layout,omitempty" yaml:"default_section_layout,omitempty" required:"false" doc:""`
	Name                 string `json:"name,omitempty" yaml:"name,omitempty" required:"false" doc:""`
	SsdCapacityTb        int64  `json:"ssd_capacity_tb,omitempty" yaml:"ssd_capacity_tb,omitempty" required:"false" doc:""`
}
...
type SupportedDriversUpsertModel struct {
	Drives    *[]SupporteddriveModel_DrivesItem    `json:"drives,omitempty" yaml:"drives,omitempty" required:"false" doc:"List of supported drives"`
	Platforms *[]SupporteddriveModel_PlatformsItem `json:"platforms,omitempty" yaml:"platforms,omitempty" required:"false" doc:"List of supported hw platforms"`
	Replace   bool                                 `json:"replace,omitempty" yaml:"replace,omitempty" required:"false" doc:"Remove drives not present in data"`
	Signature string                               `json:"signature,omitempty" yaml:"signature,omitempty" required:"false" doc:"Signature, base64-encoded"`
	Version   string                               `json:"version,omitempty" yaml:"version,omitempty" required:"false" doc:"Version"`
}
...
// GetById retrieves a single supporteddrivers by ID
func (r *SupportedDrivers) GetById(id any) (*SupportedDriversDetailsModel, error) {
	return r.GetByIdWithContext(r.Untyped.GetCtx(), id)
}

// GetByIdWithContext retrieves a single supporteddrivers by ID using provided context
func (r *SupportedDrivers) GetByIdWithContext(ctx context.Context, id any) (*SupportedDriversDetailsModel, error) {
