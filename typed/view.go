...
// ViewCreateBody_BucketLogging represents a nested type for create body
type ViewCreateBody_BucketLogging struct {
...
// ViewCreateBody_CreateDirAclItem represents a nested type for create body
type ViewCreateBody_CreateDirAclItem struct {
...
// ViewCreateBody_ShareAcl represents a nested type for create body
type ViewCreateBody_ShareAcl struct {
	Acl     []ViewCreateBody_ShareAcl_AclItem `json:"acl,omitempty" yaml:"acl,omitempty" required:"false" doc:"Share-level ACL"`
...
// ViewCreateBody_ShareAcl_AclItem represents a nested type for create body
type ViewCreateBody_ShareAcl_AclItem struct {
...
// ViewCreateBody_UserImpersonation represents a nested type for create body
type ViewCreateBody_UserImpersonation struct {
...
// ViewCreateBody represents the create body for View operations
...
type ViewCreateBody struct {
	...
	BucketLogging                 ViewCreateBody_BucketLogging      `json:"bucket_logging,omitempty" yaml:"bucket_logging,omitempty" required:"false" doc:""`
	...
	CreateDirAcl                  []ViewCreateBody_CreateDirAclItem `json:"create_dir_acl,omitempty" yaml:"create_dir_acl,omitempty" required:"false" doc:"Define ACL for the newly created dir"`
	...
	ShareAcl                      ViewCreateBody_ShareAcl           `json:"share_acl,omitempty" yaml:"share_acl,omitempty" required:"false" doc:"Share-level ACL details"`
	...
	UserImpersonation             ViewCreateBody_UserImpersonation  `json:"user_impersonation,omitempty" yaml:"user_impersonation,omitempty" required:"false" doc:""`
}
...
// ViewModel_BucketLogging represents a nested type for model
type ViewModel_BucketLogging struct {
...
// ViewModel_EventNotificationsItem represents a nested type for model
type ViewModel_EventNotificationsItem struct {
...
// ViewModel_ShareAcl represents a nested type for model
type ViewModel_ShareAcl struct {
	Acl     []ViewModel_ShareAcl_AclItem `json:"acl,omitempty" yaml:"acl,omitempty" required:"false" doc:"Share-level ACL"`
	Enabled bool                         `json:"enabled,omitempty" yaml:"enabled,omitempty" required:"false" doc:"True if Share ACL is enabled on the view, otherwise False"`
}

// ViewModel_ShareAcl_AclItem represents a nested type for model
type ViewModel_ShareAcl_AclItem struct {
...
// ViewModel_UserImpersonation represents a nested type for model
type ViewModel_UserImpersonation struct {
	Enabled        bool   `json:"enabled,omitempty" yaml:"enabled,omitempty" required:"false" doc:"True if user impersonation is enabled"`
	Identifier     string `json:"identifier,omitempty" yaml:"identifier,omitempty" required:"false" doc:"Identifier of the user to impersonate"`
	IdentifierType string `json:"identifier_type,omitempty" yaml:"identifier_type,omitempty" required:"false" doc:"The identifier type of the specified identifier."`
	LoginName      string `json:"login_name,omitempty" yaml:"login_name,omitempty" required:"false" doc:"Full username of user to impersonate, including domain name"`
...
// ViewModel represents the model data for View operations
...
type ViewModel struct {
	...
	EventNotifications            []ViewModel_EventNotificationsItem `json:"event_notifications,omitempty" yaml:"event_notifications,omitempty" required:"false" doc:""`
	FilesRetentionMode            string                             `json:"files_retention_mode,omitempty" yaml:"files_retention_mode,omitempty" required:"false" doc:"Applicable if locking is enabled. The retention mode for new files. For views enabled for NFSv3 or SMB, if locking is enabled, files_retention_mode must be set to GOVERNANCE or COMPLIANCE. If the view is enabled for S3 and not for NFSv3 or SMB, files_retention_mode can be set to NONE. If GOVERNANCE, locked files cannot be deleted or changed. The Retention settings can be shortened or extended by users with sufficient permissions. If COMPLIANCE, locked files cannot be deleted or changed. Retention settings can be extended, but not shortened, by users with sufficient permissions. If NONE (S3 only), the retention mode is not set for the view; it is set individually for each object."`
	Guid                          string                             `json:"guid,omitempty" yaml:"guid,omitempty" required:"false" doc:""`
	...
	ShareAcl                      ViewModel_ShareAcl                 `json:"share_acl,omitempty" yaml:"share_acl,omitempty" required:"false" doc:"Share-level ACL details"`
	...
	UserImpersonation             ViewModel_UserImpersonation        `json:"user_impersonation,omitempty" yaml:"user_impersonation,omitempty" required:"false" doc:""`
}
...
func (r *View) GetById(id any) (*ViewModel, error) {
...
func (r *View) GetByIdWithContext(ctx context.Context, id any) (*ViewModel, error) {
...
func (r *View) Create(req *ViewCreateBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) CreateWithContext(ctx context.Context, req *ViewCreateBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) Update(id any, req *ViewCreateBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) UpdateWithContext(ctx context.Context, id any, req *ViewCreateBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) EnsureByName(name string, body *ViewCreateBody) (*ViewModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
...
func (r *View) EnsureByNameWithContext(ctx context.Context, name string, body *ViewCreateBody) (*ViewModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
