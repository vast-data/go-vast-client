...
func (r *View) Create(req *ViewRequestBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) CreateWithContext(ctx context.Context, req *ViewRequestBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) Update(id any, req *ViewRequestBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) UpdateWithContext(ctx context.Context, id any, req *ViewRequestBody) (*ViewModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *View) Ensure(searchParams *ViewSearchParams, body *ViewRequestBody) (*ViewModel, error) {
...
func (r *View) EnsureWithContext(ctx context.Context, searchParams *ViewSearchParams, body *ViewRequestBody) (*ViewModel, error) {
	searchParamsConverted, err := vast_client.NewParamsFromStruct(searchParams)
	if err != nil {
		return nil, err
	}
...
func (r *View) EnsureByName(name string, body *ViewRequestBody) (*ViewModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
...
func (r *View) EnsureByNameWithContext(ctx context.Context, name string, body *ViewRequestBody) (*ViewModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
...
// PrettyTable returns a formatted table representation of the ViewModel
func (m *ViewModel) PrettyTable() string {
	return m.toRecord().PrettyTable()
}

// PrettyJson returns a JSON representation of the ViewModel
func (m *ViewModel) PrettyJson(indent ...string) string {
	return m.toRecord().PrettyJson(indent...)
}

// toRecord converts the ViewModel to a Record (map[string]any) with @resourceType
func (m *ViewModel) toRecord() vast_client.Record {
