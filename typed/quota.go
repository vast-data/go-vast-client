...
// QuotaModel represents the model data for Quota operations
...
func (r *Quota) GetById(id any) (*QuotaModel, error) {
...
func (r *Quota) GetByIdWithContext(ctx context.Context, id any) (*QuotaModel, error) {
