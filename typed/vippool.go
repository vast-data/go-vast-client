...
func (r *VipPool) Create(req *VipPoolRequestBody) (*VipPoolModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) CreateWithContext(ctx context.Context, req *VipPoolRequestBody) (*VipPoolModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) Update(id any, req *VipPoolRequestBody) (*VipPoolModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) UpdateWithContext(ctx context.Context, id any, req *VipPoolRequestBody) (*VipPoolModel, error) {
	params, err := vast_client.NewParamsFromStruct(req)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) Ensure(searchParams *VipPoolSearchParams, body *VipPoolRequestBody) (*VipPoolModel, error) {
...
func (r *VipPool) EnsureWithContext(ctx context.Context, searchParams *VipPoolSearchParams, body *VipPoolRequestBody) (*VipPoolModel, error) {
	searchParamsConverted, err := vast_client.NewParamsFromStruct(searchParams)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) EnsureByName(name string, body *VipPoolRequestBody) (*VipPoolModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
...
func (r *VipPool) EnsureByNameWithContext(ctx context.Context, name string, body *VipPoolRequestBody) (*VipPoolModel, error) {
	bodyConverted, err := vast_client.NewParamsFromStruct(body)
	if err != nil {
		return nil, err
	}
...
// PrettyTable returns a formatted table representation of the VipPoolModel
func (m *VipPoolModel) PrettyTable() string {
	return m.toRecord().PrettyTable()
}

// PrettyJson returns a JSON representation of the VipPoolModel
func (m *VipPoolModel) PrettyJson(indent ...string) string {
	return m.toRecord().PrettyJson(indent...)
}

// toRecord converts the VipPoolModel to a Record (map[string]any) with @resourceType
func (m *VipPoolModel) toRecord() vast_client.Record {
