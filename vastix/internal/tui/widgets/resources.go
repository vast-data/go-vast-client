...
func InitializeWidgets(db *database.Service, restClient *rest.UntypedVMSRest) (*WidgetFactory, error) {
	...
	factory.CreateAndRegisterWidgetMust(restClient.Hosts, []string{"id", "hostname", "host_label", "state", "cluster", "build"})
	factory.CreateAndRegisterWidgetMust(restClient.VirtualMachines, []string{"id", "name", "state", "arch_type", "cluster_id"})
	factory.CreateAndRegisterWidgetMust(restClient.WebHooks, []string{"id", "name", "url", "method", "enabled"})
	factory.CreateAndRegisterWidgetMust(restClient.VTasks, []string{"id", "name", "state", "start_time", "end_time"})
