...
Due to the extensive size of the VAST API (with hundreds of resources and operations), manually testing every endpoint
and resource type became impractical. 

Vastix was created to address this challenge by providing an easy-to-use TUI for interactive testing and exploration 
of go-vast-client resources. This approach enables rapid testing, debugging, and validation of the autogenerated code 
without writing individual test scripts for each resource.
