...
func TestParams_FromStruct(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: Params{"name": "John", "age": float64(30)}, // JSON unmarshaling converts numbers to float64
			wantErr:  false,
		},
		{
		...
		},
		{
			...
			expected: Params{"name": "Alice", "age": float64(25)},
			wantErr:  false,
		},
		{
		...
		},
		{
			...
			expected: Params{"tags": []interface{}{"tag1", "tag2"}},
			wantErr:  false,
		},
		{
...
func TestNewParamsFromStruct(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: Params{"name": "Test", "age": float64(20)},
			wantErr:  false,
		},
		{
...
func TestNewParamsFromStruct_RawData(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: Params{"name": "John", "age": float64(30)},
			wantErr:  false,
		},
		{
			...
			expected: Params{"name": "Jane", "age": float64(25)},
			wantErr:  false,
		},
		{
		...
		},
		{
			...
			expected: Params{"name": "Normal", "age": float64(40)},
			wantErr:  false,
		},
	}
